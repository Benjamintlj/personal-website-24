...
[https://youtu.be/CRdL1PcherM](https://youtu.be/CRdL1PcherM)
...
![Untitled](Networking%20Models/Untitled.png)
...
For example, `ICMP` (`Internet Control Message Protocol`) or `UDP` (`User Datagram Protocol`)
...
`OSI`, on the other hand, is a communication gateway between the network and end-users. The OSI model is usually referred to as the reference model because it is older. It is also known for its 
...
![Untitled](Networking%20Models/Untitled%201.png)
