...
export const Menu = ({
    ...
    return (
        <nav
            ...
            className="relative rounded-full border border-transparent dark:bg-black/60 dark:border-white/[0.2] bg-white/60 backdrop-blur-md shadow-input flex justify-between items-center px-8 py-6"
        >
            {children}
        </nav>
    )
