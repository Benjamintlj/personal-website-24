...
export const DesktopSidebar = ({
    ...
    return (
        <motion.div
            className={cn(
                'h-full px-4 py-4 hidden md:flex md:flex-col bg-neutral-900 border-r border-neutral-800 shrink-0',
                className,
            )}
            animate={{
...
export const MobileSidebar = ({
    ...
    return (
        <>
            <div
                className={cn(
                    'h-10 px-4 py-4 flex flex-row md:hidden items-center justify-between bg-neutral-900 border-b border-neutral-800 w-full',
                )}
                {...props}
            >
