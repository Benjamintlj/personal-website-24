            ...
            {meteors.map((_el, idx) => {
                ...
                return (
                    <span
                        key={'meteor' + idx}
                        className={cn(
                            'animate-meteor-effect absolute h-0.5 w-0.5 rotate-[45deg] rounded-[9999px] bg-violet-400 shadow-[0_0_0_1px_#ffffff10]',
                        ...
                        style={{
                            ...
                            animationDuration: Math.floor(Math.random() * (20 - 12) + 12) + 's',
                        }}
                    />
                )
            })}
