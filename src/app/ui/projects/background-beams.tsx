...
export const BackgroundBeams = React.memo(({ className }: { className?: string }) => {
    ...
    const paths = allPaths.filter((_, i) => i % 2 === 0)
    ...
    return (
        ...
        >
            <svg
                ...
                width="100%"
                height="100%"
                viewBox="200 0 496 316"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
            >
                <defs>
                    <linearGradient id="beamGradient" x1="200" y1="0" x2="696" y2="316" gradientUnits="userSpaceOnUse">
                        <stop offset="0%" stopColor="#8B5CF6" />
                        <stop offset="40%" stopColor="#D946EF" />
                        <stop offset="100%" stopColor="#FBBF24" />
                    </linearGradient>
                    <radialGradient id="centerHide" cx="448" cy="158" r="220" gradientUnits="userSpaceOnUse">
                    ...
                    <mask id="linesMask">
                        ...
                        {/* Black radial gradient erases lines from center outward */}
                        <rect x="-400" y="-400" width="1800" height="1200" fill="url(#centerHide)" />
                    </mask>
                </defs>

                {/* Gradient visible through line mask */}
                <rect
                    x="-400" y="-400" width="1800" height="1200"
